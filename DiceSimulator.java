...
class Main {
  ...
  public static void Display500Prob(){
    ...
    System.out.print("Em Prob:  " + df.format(c_500_a[1] / probBase) + "     " + df.format(c_500_a[2] / probBase) + "     " + df.format(c_500_a[3] / probBase) + "     "  + df.format(c_500_a[4] / probBase) + "     " + df.format(c_500_a[5] / probBase) + "     " +  df.format(c_500_a[6] / probBase) + "     " + df.format(c_500_a[7] / probBase) + "     " + df.format(c_500_a[8] / probBase) + "     " + df.format(c_500_a[9] / probBase) + "     " +  df.format(c_500_a[10] / probBase) + "     " + df.format(c_500_a[11] / probBase) + " \t\n");
    System.out.print("P(X):  \t  " + df.format(1 / probBase) + "     " + df.format(2 / probBase) + "     " + df.format(3 / probBase) + "     "  + df.format(4 / probBase) + "     " + df.format(5 / probBase) + "     " +  df.format(6 / probBase) + "     " + df.format(5 / probBase) + "     " + df.format(4 / probBase) + "     " + df.format(3 / probBase) + "     " +  df.format(2 / probBase) + "     " + df.format(1 / probBase) + " \t\n");
